...
} from '../apps/web-v2/lib/portfolioTransforms';
...
const TOKENS = {
  ...
  cbBTC: '0xb0b47f113bcab2b0e49fd5d3bd2cc0e9aa408b29' as `0x${string}`,
  WETH: '0xd116ab1c943cf15904ec4c8dd701086f175fa323' as `0x${string}`,
};
...
async function main() {
  ...
  const rawUserData = {
    userAddress: TEST_WALLET as `0x${string}`,
