...
contract MainnetDeploymentValidationTest is Test {
    ...
    function test_ValidateFullMainnetDeployment() public {
        ...
        assertEq(directory.getAddress(ModuleIds.LIQUIDITY_MANAGER), address(deployScript.liquidityManager()));
        ...
        assertEq(directory.getAddress(ModuleIds.STRATEGY_MANAGER), address(deployScript.strategyManager()));
        assertEq(directory.getAddress(ModuleIds.PORTFOLIO_MANAGER), address(deployScript.portfolioManager()));
