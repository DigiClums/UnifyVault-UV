...
contract RateLimitsTest is Test {
  ...
  function test_DepositExceedsTxLimitReverts() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(ProtocolErrors.DepositExceedsTxLimit.selector, 1001e6, 1000e6)
    );
  ...
  function test_RedeemExceedsTxLimitReverts() public {
    ...
    vm.expectRevert(
      abi.encodeWithSelector(ProtocolErrors.RedeemExceedsTxLimit.selector, 501e18, 500e18)
    );
