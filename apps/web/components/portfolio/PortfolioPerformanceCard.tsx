  ...
  return (
    <div className="rounded-2xl border border-border bg-card/90 dark:bg-[#111827]/60 p-6 backdrop-blur-md shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6">
        <div>
          <h3 className="text-lg font-bold text-foreground">Portfolio Overview</h3>
          <p className="text-xs text-muted-foreground mt-0.5">
            Real-time on-chain valuation and portfolio allocation metrics
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="p-4 rounded-xl bg-muted/40 dark:bg-gray-900/40 border border-border/80">
          ...
          <span className="text-[11px] text-muted-foreground">Historical Deposits</span>
        </div>

        <div className="p-4 rounded-xl bg-muted/40 dark:bg-gray-900/40 border border-border/80">
          <span className="text-xs text-muted-foreground font-medium">Estimated Gain</span>
