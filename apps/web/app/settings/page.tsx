  ...
  return (
    <Container>
      <PageWrapper className="space-y-6">
        ...
        <div className="min-h-[300px] rounded-xl border border-border bg-card/80 dark:bg-card/50 shadow-sm dark:shadow-none flex flex-col items-center justify-center p-6 text-center">
