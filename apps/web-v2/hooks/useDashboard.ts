...
export function useDashboard(): DashboardMetrics {
  ...
  return {
    ...
    backingValueUSD: data.backingValueUSD || data.totalVaultNAVUSD,
    navPerShareUSD: data.navPerShareUSD,
    sharePriceUSD: data.sharePriceUSD,
    currentUVPriceUSD: data.currentUVPriceUSD || data.sharePriceUSD,
    ...
    walletBalanceRaw: data.walletBalanceRaw,
    walletBalanceFormatted: data.walletBalanceFormatted,
    vaultPortfolio: data.vaultPortfolio,
    p2pTrading: data.p2pTrading,
    escrowLocked: data.escrowLocked,
    hasP2PShares: data.hasP2PShares,
    hasLockedShares: data.hasLockedShares,
