...
import {
  GET as GET_DISPUTE,
  POST as POST_DISPUTE_MSG,
} from '../../../app/api/p2p/dispute-chat/messages/route';
...
describe('Phase 7.4 — Controlled P2P End-to-End Regression Suite', () => {
  ...
  it('3. Dispute chat workspace enforces participant auth and admin non-custodial audit action', async () => {
    ...
    expect(dataAdmin.statusMessage).toContain(
      'On-chain release requires seller wallet transaction',
    );
  });
