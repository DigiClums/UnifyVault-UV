...
export const CANONICAL_BASE_SEPOLIA_V2 = {
  ...
  UnifyVaultController: '0x7DC190a0bFa08c9596DfdC20E602821619E776ea',
  ...
  Admin: '0xd905920c91853039060246Ed5724AA72B91a96DA',
  ...
  describe('3. Protocol Module IDs Verification', () => {
    it('verifies all 13 module IDs match on-chain ModuleIds.sol', () => {
      ...
      expect(MODULE_IDS.P2P_ESCROW).toBe(
        '0x4d5e9ec2ddae603ed61a153eeaa5905d914ec7a7a505e83ea647904cf72d8a57',
      );
    });
  });
