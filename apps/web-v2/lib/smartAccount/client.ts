    ...
    paymaster: {
      getPaymasterStubData: async (userOp) => {
        ...
        return {
          ...
          // Do NOT forward preVerificationGas / verificationGasLimit / callGasLimit.
          // Leaving them undefined lets viem's `prepareUserOperation` invoke
          // `eth_estimateUserOperationGas` on the bundler, which correctly measures
          // first-deployment (initCode) verification gas instead of a hardcoded 150000.
        };
      },
