      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_.95fr] lg:gap-14">
        <div>
          ...
          <p className="mt-6 max-w-xl text-sm leading-7 text-white/55 sm:text-base">
            Transparent exposure to the two leading assets through one audited, non-custodial
            portfolio.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-x-5 gap-y-3 border-t border-white/10 pt-5">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-1.5 text-[9px] font-bold tracking-[0.14em] text-white/35"
              >
          ...
          <div className="mt-6 flex items-center gap-3 font-mono text-xs">
            ...
            <span className="text-white/70">
              {livePrices.isLive ? formatUSD(livePrices.btcPriceUSD) : '—'}
            </span>
            <span className="text-white/20">/</span>
            <span className="font-semibold text-[#BFFF00]">ETH</span>
            <span className="text-white/70">
              {livePrices.isLive ? formatUSD(livePrices.ethPriceUSD) : '—'}
            </span>
            {livePrices.isLive && (
              <span className="ml-1 h-1.5 w-1.5 rounded-full bg-[#BFFF00] animate-pulse" />
            )}
          </div>
        </div>
        ...
        <div className="relative mx-auto w-full max-w-[520px]">
          ...
          <div className="relative overflow-hidden border-2 border-white/10 bg-[#0b0b0b]/95 p-5 shadow-[6px_6px_0_#BFFF00] backdrop-blur-xl sm:p-6">
            ...
            <div className="flex items-start justify-between border-b border-white/10 pb-5">
              <div>
                <div className="text-xl font-black tracking-tight text-white">UVBE</div>
                <div className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/35">
                  Multi-Asset Index
                </div>
              </div>
              <span className="border border-[#BFFF00]/30 bg-[#BFFF00]/10 px-2 py-1 text-[8px] font-bold tracking-[0.14em] text-[#BFFF00]">
                PRIMARY STRATEGY
              </span>
            </div>

            <div className="py-6">
              <div className="text-[9px] font-bold tracking-[0.16em] text-white/35">
                CURRENT NAV
              </div>
            ...
            <div className="mt-6 border-t border-white/10 pt-4 text-[9px] leading-5 text-white/30">
              Configured UVBE target allocation · NAV sourced from the existing protocol data.
            </div>
          </div>
        </div>
      </div>
