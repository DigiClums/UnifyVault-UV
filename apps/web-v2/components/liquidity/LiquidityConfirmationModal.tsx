...
export interface LiquidityConfirmationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isPending: boolean;
...
export function LiquidityConfirmationModal({
  isOpen,
  onClose,
  onConfirm,
  isPending,
  title,
  description,
  actionLabel = 'Confirm Liquidity Action',
  actionColor = 'purple',
  warningMessage,
  details,
}: LiquidityConfirmationModalProps) {
