  ...
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 py-6 mt-16 text-xs transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        {/* Main Footer Row */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-600 dark:text-slate-400">
          <div className="flex items-center space-x-2">
            <ShieldCheck className="w-4 h-4 text-accent-blue shrink-0" />
            <span className="font-semibold text-slate-900 dark:text-white">
              UnifyVault V2 Protocol
            </span>
          ...
          <div className="flex flex-wrap items-center gap-4 font-medium">
            <Link
              href="/contracts"
              className="text-slate-700 dark:text-slate-300 hover:text-accent-blue transition-colors flex items-center space-x-1"
            >
            ...
            <button
              ...
              className="flex items-center space-x-1 hover:text-accent-blue transition-colors font-mono text-[11px] px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 shadow-2xs"
            >
            ...
            <Link
              href="/transactions"
              className="text-slate-700 dark:text-slate-300 hover:text-accent-blue transition-colors"
            >
              Activity Explorer
            </Link>
        ...
        {panelOpen && (
          <div className="mt-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 font-mono shadow-xs animate-fadeIn">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-200 dark:border-slate-800 font-sans">
              <div className="flex items-center space-x-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 text-[11px]">
              {footerContracts.map((c) => {
                ...
                return (
                  <div
                    key={c.name}
                    className="p-2.5 rounded-lg bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-1.5 shadow-2xs"
                  >
                    ...
                    <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 pt-0.5">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-800 text-accent-blue transition-colors"
