...
export const DEPLOYED_CONTRACTS_MAINNET = {
  ...
  StakingVault: '0x6fb5dede967270aeb1a893eaaccd123c7d0cfe86' as `0x${string}`,
  UVBEStakingVault: '0x6fb5dede967270aeb1a893eaaccd123c7d0cfe86' as `0x${string}`,
  ReferralRegistry: '0x3b3eabedbcd4de77bb89f00d1e94fa482ecaac6a' as `0x${string}`,
  UVBEReferralRegistry: '0x3b3eabedbcd4de77bb89f00d1e94fa482ecaac6a' as `0x${string}`,
  RewardDistributor: '0x8f6169ed7091ed14bb4cdfdda9e7cedbf366c7dd' as `0x${string}`,
