...
export const DEPLOYED_CONTRACTS_SEPOLIA = {
  ...
  UnifyVaultController: '0x923a55e96bb5FaeDe0C05b4aA31cB61b9cc83546' as `0x${string}`,
  StrategyManager: '0x50DA43Ebf007d7580140871ACF81e5FBAEF5E958' as `0x${string}`,
  PortfolioManager: '0xa624fdcD3840B3443fBb386F03BDEE75479654Ff' as `0x${string}`,
  ...
  CostBasisManager: '0x627bDaEf795df800d91a949d5cb3148022763A38' as `0x${string}`,
  PerformanceManager: '0x1346fc4e27Dfe32326b429C25427A45B809E8A89' as `0x${string}`,
