...
| `apps/web-v2/constants/index.ts`                            | Lines 46–48   | `0x7EF5D93f83995228efFc63dbe513367a719f0633`                                                                                                                                                      | Mainnet ProtocolDirectory fallback     |     **D**      | Replace with newly deployed Mainnet `ProtocolDirectory` address via `NEXT_PUBLIC_DIRECTORY_ADDRESS_MAINNET` |         **YES**         |
...
| `packages/protocol/script/mainnet/config/base_mainnet.json` | Lines 2–4     | `newAdmin: 0xd905...`<br>`guardian: 0xd905...`                                                                                                                                                    | Governance migration configuration     |     **E**      | Human decision: Determine if Mainnet will launch with Single Admin EOA or immediate Gnosis Safe.            |         **YES**         |
